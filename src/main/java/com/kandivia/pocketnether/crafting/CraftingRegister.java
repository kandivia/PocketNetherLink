...
//Items
	...
	//Nether Quartz Ore
	    GameRegistry.addShapelessRecipe(netherQuartzOre, netherLink, RegisterBlocks.overworld_quartz_ore);
	//Wither Skull
	...
	public static void addSmeltingRecipies() {
		GameRegistry.addSmelting(RegisterBlocks.overworld_quartz_ore, quartz, 0.2F);
	}
}