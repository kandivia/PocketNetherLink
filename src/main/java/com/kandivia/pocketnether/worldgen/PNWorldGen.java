...
public class PNWorldGen implements IWorldGenerator{
	...
	private void generateSurface(World world, Random random, int x, int z) {
		this.addOreSpawn(RegisterBlocks.overworld_quartz_ore, world, random, x, z, 16, 16, 
	...
	private void addOreSpawn(Block block, World world, Random random, int blockXPos, int blockZPos, 
		...
		for(int i = 0; i < chanceToSpawn; i++){
			...
			new WorldGenMinable(RegisterBlocks.overworld_quartz_ore.getDefaultState(), maxVeinSize).generate(world, random, coords);
		}
	}
}
